...
<body>
    ...
    <header class="w3-container w3-red w3-center" style="padding:80px 16px">
      ...
      <div class="login-page">
        <div class="form">
          <form class="login-form" action="final" method="POST">
              @csrf
            <label>Address:</label></br></br>
            {{ session('user')->address }}</br></br>
            <label>Total Cart Amount:</label></br></br>
            <input type="text" placeholder="Total Amount" id="queryString"  name="totalamt" readonly/></br></br>
            Select Payment Type:</br></br>
             <input type="radio" name="pay" value="COD" required>COD</br>
            <input type="radio" name="pay" value="Online" required>Online</br>
    ...
    <script>
        ...
        var queries = queryString.split("cartvalue=");
       console.log(query);

       // query = query.substring(1);
        //var querys = query.split("quantity=");
      //  console.log(queryString);
        //console.log(queries[1]);

        //document.getElementById('queryString').value=queries[1];
        document.getElementById('queryString').value=queries[1];
