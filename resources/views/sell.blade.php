...
<body>
    ...
    <header class="w3-container w3-red w3-center" style="padding:80px 16px">
        <h1 class="w3-margin w3-jumbo">SELL PLASTIC WASTE</h1>
      </header>
{{-- --}}
      <div class="login-page">
        <div class="form">
        <div id="login">
          <form class="login-form" action="sell" method="POST" enctype="multipart/form-data">
              @csrf
              <label>Product Name:</label>
            <input type="text" placeholder="Enter Product Name" name="prodname" required/>
            <label>Quantity:</label>
            <input type="text" placeholder="Enter Quantity in Kilograms" name="quantity" required/>
            <label>Description:</label>
            <textarea placeholder="Enter Desc" name="desc" rows="4" cols="20" required></textarea>
            Select Image:
            <input type="file" id="img" name="image" accept="image/* " required>

           <div class="w3-red"> <button>SUBMIT</button></div>
